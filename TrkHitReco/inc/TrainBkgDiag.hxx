//Code generated automatically by TMVA for Inference of Model file [TrainBkgDiag.h5] at [Mon May 18 20:55:01 2026] 
...
std::vector<float> fTensor_dense20kernel0 = std::vector<float>(448);
