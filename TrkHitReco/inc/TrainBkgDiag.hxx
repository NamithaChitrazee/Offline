//Code generated automatically by TMVA for Inference of Model file [TrainBkgDiag.h5] at [Sun Jun  7 00:29:00 2026] 
...
std::vector<float> fTensor_dense20kernel0 = std::vector<float>(704);
