//Code generated automatically by TMVA for Inference of Model file [TrainBkgDiag.h5] at [Sat Jun  6 23:53:20 2026] 
...
std::vector<float> fTensor_dense12kernel0 = std::vector<float>(704);
